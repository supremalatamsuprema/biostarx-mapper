...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "migration.tnaStandardUpgradeWarning": "Teniendo en cuenta que usted cuenta con una licencia de Tiempo y Asistencia en BioStar 2, Suprema le entregará una licencia de Tiempo y Asistencia nivel Standard de BioStar X sin costo (FOC). Sin embargo, la cantidad de usuarios que requiere para su proyecto supera los 500 usuarios permitidos por la licencia Standard de Tiempo y Asistencia de BioStar X (BIOSTARX-ADD-TNA-STD). Por lo tanto, deberá adquirir la licencia de Tiempo y Asistencia nivel Enterprise de BioStar X (BIOSTARX-ADD-TNA-ENT) con costo, la cual soporta más de 500 usuarios.",
