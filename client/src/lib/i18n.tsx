...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "validation.maxDevicesExceeded": "La cantidad máxima de dispositivos soportada por un servidor de BioStar X es de 1,000 dispositivos. Por favor póngase en contacto con su representante de ventas para asesoría sobre la función MCS (Multi-server Clustering).",
  ...
  en: {
    ...
    "validation.maxDevicesExceeded": "The maximum number of devices supported by a single BioStar X server is 1,000 devices. Please contact your sales representative for guidance on the MCS (Multi-server Clustering) feature.",
  ...
  pt: {
    ...
    "validation.maxDevicesExceeded": "O número máximo de dispositivos suportado por um servidor BioStar X é de 1.000 dispositivos. Entre em contato com seu representante de vendas para orientação sobre a função MCS (Multi-server Clustering).",
