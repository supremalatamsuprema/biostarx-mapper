      ...
      <div className="max-w-6xl w-full relative z-10 space-y-8 sm:space-y-12 animate-fadeIn">
        <div className="text-center space-y-4 max-w-4xl mx-auto">
          <div className="flex flex-col items-center justify-center gap-y-3 mb-4">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl text-foreground tracking-tight leading-none" style={{ fontFamily: "'Noto Sans KR', sans-serif", fontWeight: 900 }}>
              {t("app.welcome")}
            </h1>
            <img 
              src={BioStar_X_LOGO2} 
          ...
          <p className="text-muted-foreground text-base sm:text-lg font-medium leading-relaxed max-w-2xl mx-auto text-justify">
            {t("app.description")}
          </p>
        </div>
